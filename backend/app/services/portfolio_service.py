...
class PortfolioService:
    ...
    @staticmethod
    def _calculate_fund_metrics(portfolio_fund, target_date=None, all_dividends=None, force_historical_format=False):
        """
        ...
        for portfolio in portfolios:
            ...
            if portfolio_fund_ids:
                dividends = (
                    ...
                    .join(Transaction, Dividend.reinvestment_transaction_id == Transaction.id, isouter=True)
                    .with_entities(
    ...
    def calculate_portfolio_fund_values(portfolio_funds):
        ...
        """
        return [
            PortfolioService._calculate_fund_metrics(pf) 
    ...
    @staticmethod
    def _calculate_daily_values(current_date, portfolios, portfolio_date_ranges, all_dividends):
        """
