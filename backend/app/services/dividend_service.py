...
from ..models import db, Dividend, Fund, PortfolioFund, Transaction, DividendType, ReinvestmentStatus
import uuid
...
class DividendService:
    ...
    def create_dividend(data):
        ...
        dividend = Dividend(
            ...
            buy_order_date=datetime.strptime(data['buy_order_date'], '%Y-%m-%d').date() if data.get('buy_order_date') else None
        )
        ...
        if (portfolio_fund.fund.dividend_type == DividendType.STOCK and 
            data.get('reinvestment_shares') and data.get('reinvestment_price')):
    ...
    def format_dividend(dividend):
        ...
        return {
            ...
            'buy_order_date': dividend.buy_order_date.isoformat() if dividend.buy_order_date else None,
        ...
        try:
            ...
            if dividend.reinvestment_transaction_id:
                ...
                if transaction:
                    ...
                    print(f"Associated transaction {dividend.reinvestment_transaction_id} not found")
