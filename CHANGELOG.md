...
### Fixed
- **Critical: IBKR Transaction Allocation API Mismatch** - See [PR #TBD](https://github.com/ndewijer/Investment-Portfolio-Manager/pull/TBD)
...
### Technical Details
- Updated `frontend/src/pages/IBKRInbox.js`:
